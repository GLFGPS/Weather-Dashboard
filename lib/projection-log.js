    ...
    schemaReady = (async () => {
      await dbQuery(`
        CREATE TABLE IF NOT EXISTS projection_log (
          ...
          model_version TEXT DEFAULT '2026-03-25',
          notes TEXT,
  ...
  await dbQuery(
    `
      ...
      DO UPDATE SET
        ...
        projected_organic = EXCLUDED.projected_organic,
        projected_dm = EXCLUDED.projected_dm,
